package net.nickyrabit.androidtablayout.t_DetailActivity;
...
import net.nickyrabit.androidtablayout.MainActivity;
import net.nickyrabit.androidtablayout.R;
import net.nickyrabit.androidtablayout.UI_t.PicassoClient_t;
